...
public class DefaultValues {
    ...
    public static final int IN_MEMORY_LAYER_COUNT = 100;
    public static final double ANOMALY_HIGH_THRESHOLD_DEFAULT = 0.9;
    ...
    public static final double STD_INTERSECT_STRENGTH = 0.5;
    public static final double MIN_INTERSECT_STRENGTH = 0.2;
    public static final double FIND_PARENT_THRESHOLD = 0.75;
